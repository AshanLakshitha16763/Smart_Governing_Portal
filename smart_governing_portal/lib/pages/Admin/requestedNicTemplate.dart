...
class RequestedNICTemplate extends StatefulWidget {
  final String documentId;
  const RequestedNICTemplate({
    super.key,
    required this.documentId,
  });

  @override
  State<RequestedNICTemplate> createState() => _RequestedNICTemplateState();
}

class _RequestedNICTemplateState extends State<RequestedNICTemplate> {
