...
class AdminRegisterMobile extends StatefulWidget {
  const AdminRegisterMobile({super.key});

  @override
  _AdminRegisterMobileState createState() => _AdminRegisterMobileState();
}

class _AdminRegisterMobileState extends State<AdminRegisterMobile> {
